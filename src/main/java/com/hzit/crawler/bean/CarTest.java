...
public class CarTest {
    ...
    public CarTest(Long id, String title, int test_speed, int test_brake, int test_oil, String editor_name1, String editor_remark1, String editor_name2, String editor_remark2, String editor_name3, String editor_remark3, String image, Date created, Date updated) {
